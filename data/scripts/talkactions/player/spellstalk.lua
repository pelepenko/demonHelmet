local spellsTalkScript = TalkAction("!spells", "!spell", "!magias", "!magia")

function spellsTalkScript.onSay(player, words, param)
	...
	player:showTextDialog(11401, text)
	
	return true
end

spellsTalkScript:register()
