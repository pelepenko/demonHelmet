...
monster.health = 12515
monster.maxHealth = 12515
monster.race = "undead"
monster.corpse = 6030
monster.speed = 218
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -400, condition = {type = CONDITION_POISON, totalDamage = 100, interval = 4000}},
